...
> \* 当然最好的方式是直接使用成熟的框架、使用最多的是html5shim框架 <!--[if lt IE 9]> <script> src="[http://html5shim.googlecode.com/svn/trunk/html5.js](http://link.zhihu.com/?target=http%3A//html5shim.googlecode.com/svn/trunk/html5.js)"</script> <![endif]-->
